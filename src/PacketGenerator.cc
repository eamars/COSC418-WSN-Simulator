...
void PacketGenerator::handleMessage(cMessage *msg)
{
    ...
    {
        AppMessage *appMessage = static_cast<AppMessage *>(msg);

        // if the message is generated by itself, then transmit
        if (appMessage->getSenderId() == senderId)
        {
            // send previous message
            send(appMessage, "gate$o");
        ...
        // otherwise then discard the message
        else
        {
            delete msg;
        }
